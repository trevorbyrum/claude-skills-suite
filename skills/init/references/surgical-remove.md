...
Internal skill invoked by /init's Sonnet subagent (pivot mode). Executes approved removals
...
```
/init (pivot mode) subagent: Approved triage loaded. Candidate list has 18 files.
