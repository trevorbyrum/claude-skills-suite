...
> surgical-remove. Run `/init` (pivot mode) to continue to Phase 4."
...
- **User cancels**: Exit without storing. Inform the /init orchestrator.

## Examples

```
Invoked by /init (pivot mode) Phase 3 after impact-analysis completes.
